<template>
  <v-card :loading="loading">
    ...
    <v-toolbar flat>
      ...
      <v-toolbar-title>{{ $t('rooms') }} ({{ numberOfRooms }})</v-toolbar-title>
    ...
    <v-container fluid>
      <v-row>
        <v-col>
          ...
          <v-data-table :search="search" :headers="headers" :items="rooms" :loading="loading">
            <template v-slot:top>
...
export default {
  ...
  data: () => ({
    ...
    // rooms: [
    //   {
    //     roomId: 'room:eventheads:coca-cola',
    //     type: 'room',
    ...
    //     // },
    //     // textLabelId: 'label:room:eventheads:coca-cola:text',
    //     // numberOfViews: 34,
    //     // numberOfClicks: 10,
    //     // ctr: 30
    //   }
