<!--
Admin - Area - Component - Update About Description

A smart component that enables an Admin to update the About description.
-->
<template>
  <v-card :loading="loading">
    ...
    <v-card-title>
      ...
      {{ $t('admin-component-about-update-description')}}
      <v-spacer />
    ...
    <v-slide-y-transition>
      <v-container fluid v-if="showHelp">
        <v-row>
          <v-col class="px-4">
            <p>{{ $t('admin-component-about-update-description-help') }}</p>
          </v-col>
        </v-row>
      </v-container>
    </v-slide-y-transition>
...
export default {
  ...
  computed: {
    ...
    descriptionId () {
      return (this.aboutComponent) ? this.aboutComponent.descriptionId : undefined;
    },
    ...
    descriptionLabel () {
      return this.$i18n.t('admin-component-about-description-label');
    },

    descriptionHint () {
      return this.$i18n.t('admin-component-about-description-hint');
    },
  },
