<!--
Venue App (Admin) Fields - CreateTimeForm | A smart component that creates a new time field.
-->
<template>
        ...
        <v-stepper v-model="createFieldSteps" >
          ...
          <v-stepper-items>
            ...
            <v-stepper-content step="2">
              <apps-admin-registration-fields-time-steps-validation
                ref="stepType"
            ...
            <v-stepper-content step="3">
              <apps-admin-registration-fields-time-steps-review
                ref="stepReview"
                @submitted="submit"
                @cancel="cancel"
                @back="back"
...
export default {
  ...
  methods: {
    ...
    validationSubmitted ({ allowedHours, allowedMinutes,allowedSeconds, required, visible, editable}) {
      this.field = {
        ...this.field,
        allowedHours,
        allowedMinutes,
