      ...
      <v-stepper v-model="createFieldSteps" >
        ...
        <v-stepper-items>
          ...
          <v-stepper-content step="2">
            <apps-admin-registration-fields-text-steps-validation
              ref="stepType"
          ...
          <v-stepper-content step="3">
            <apps-admin-registration-fields-text-steps-review
              ref="stepReview"
              @submitted="submit"
              @cancel="cancel"
              @back="back"
...
export default {
  ...
  methods: {
    ...
    validationSubmitted ({ minCharacter, maxCharacter, required, visible, editable}) {
      this.field = {
        ...this.field,
        minCharacter,
        maxCharacter,
