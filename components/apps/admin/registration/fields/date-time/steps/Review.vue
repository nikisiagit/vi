            ...
            <v-list>
              ...
              <v-row>
                <v-col>
                  <v-list-item>
                    <v-list-item-content>
                      <v-list-item-title>{{ minDateRange }}</v-list-item-title>
                      <v-list-item-subtitle>{{ $t('min-date-range') }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>

                  <v-list-item>
                    <v-list-item-content>
                      <v-list-item-title>{{ maxDateRange }}</v-list-item-title>
                      <v-list-item-subtitle>{{ $t('max-date-range') }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>

                  <v-list-item>
                    <v-list-item-content>
                      <v-list-item-title>{{ allowedHours.join(",") }}</v-list-item-title>
                      <v-list-item-subtitle>{{ $t('allowed-hours') }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>

                  <v-list-item>
                    <v-list-item-content>
                      <v-list-item-title>{{ allowedMinutes.join(",") }}</v-list-item-title>
                      <v-list-item-subtitle>{{ $t('allowed-minutes') }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>

                  <v-list-item>
                    <v-list-item-content>
                      <v-list-item-title>{{ allowedSeconds.join(",") }}</v-list-item-title>
                      <v-list-item-subtitle>{{ $t('allowed-seconds') }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
...
export default {
  ...
  computed: {
    ...
    allowedHours () {
      return this.field?.allowedHours
    },
    allowedMinutes () {
      return this.field?.allowedMinutes
    },
    allowedSeconds () {
      return this.field?.allowedSeconds
    },
    minDateRange () {
      return this.field?.minDateRange
    },
    maxDateRange () {
      return this.field?.maxDateRange
    },
    placeholder () {
