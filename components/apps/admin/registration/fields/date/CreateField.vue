        ...
        <v-stepper v-model="createFieldSteps" >
          ...
          <v-stepper-items>
            ...
            <v-stepper-content step="2">
              <apps-admin-registration-fields-date-steps-validation
                ref="stepType"
            ...
            <v-stepper-content step="3">
              <apps-admin-registration-fields-date-steps-review
                ref="stepReview"
                @submitted="submit"
                @cancel="cancel"
                @back="back"
...
export default {
  ...
  methods: {
    ...
    validationSubmitted ({ minDateRange, maxDateRange, required, visible, editable}) {
      this.field = {
        ...this.field,
        minDateRange,
        maxDateRange,
